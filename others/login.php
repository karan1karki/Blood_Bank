      ...
      <section class="section hero" id="home" style="margin: 0%;" aria-label="hero">
        ...
        <div class="container">
          ...
          <div class="form-container">
            ...
            <div class="form-title">Don't Have Account<u><a href="register.php" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">Register Now</a></u></div>
          </div>
