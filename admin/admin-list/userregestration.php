...
<body id="top">
    ...
    <main>
        <div class="box">
            <div class="content">
                <div class="donor">
                    <a href="#" class="btn">List of Donors</a>
                    <table border="1">
                        <thead>
                            <tr>
                                <td>Name</td>
                        ...
                        <tbody>
                            ...
                            if (!empty($donors)) {
                                foreach ($donors as $donor) {
                                    echo <<<DONORLIST
                                        <tr> 
                                            <td><div class="item-field"><p class="text-font"> {$donor->firstname} {$donor->lastname}</p></div></td>
                                            <td><div class="item-field"><p class="text-font">{$donor->gender}</p></div></td>
                                            <td><div class="item-field"><p class="text-font">{$donor->blood_group}</p></div></td>
                ...
                <div class="needer">
                    <a href="#" class="btn">List of Needers</a>
                    <table border="1">
                        <thead>
                            <tr>
                                <td>Name</td>
                        ...
                        <tbody>
                            ...
                            if (!empty($needers)) {
                                foreach ($needers as $needer) {
                                    echo <<<NEEDERLIST
                                        <tr> 
                                            <td><div class="item-field"><p class="text-font">{$needer->firstname} {$needer->lastname}</p></div></td>
                                            <td><div class="item-field"><p class="text-font">{$needer->gender}</p></div></td>
                                            <td><div class="item-field"><p class="text-font">{$needer->group}</p></div></td>
